                ...
                <nav id="uphere">
                    <div class="nav-wrapper">
                        ...
                        <ul class="right hide-on-med-and-down">
                             <li>
                                <a href="\addjob" id="addjob" class="waves-effect waves-light btn indigo darken-3">ADD JOB</a>
                             </li>
                             <li>
                        ...
                        <div class="nav-content hide-on-small-only">
                            <ul class="tabs tabs-transparent">
                                <li class="tab"><a href="#Finance">Finance & Accounting</a></li>
                                <li class="tab"><a href="#Legal">Legal Support Service</a></li>
                                <li class="tab"><a href="#IT">IT and IT-enabled Services</a></li>
                                <li class="tab"><a href="#Sales">Sales and Marketing Support Services</a></li>
                            </ul>
                        </div>    
                    </div>
                </nav>
                    ...
                    <div class="container"> 
                        <div id="Finance" class="col s12">
                            <?php echo $__env->yieldContent('Finance'); ?>
                        </div>
                        <div id="Legal" class="col s12">
                            <?php echo $__env->yieldContent('Legal'); ?>
                        </div>
                        <div id="IT" class="col s12">
                            <?php echo $__env->yieldContent('IT'); ?>
                        </div>
