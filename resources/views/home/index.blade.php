...
{{--  fixed Navbar for Desktop  --}}
    @section('navContent')
        <ul class="left hide-on-med-and-down" style="margin-left:5%;">
            <li ><h1="" class="fa fa-phone">09090904234</h1></li>
        </ul>
        <ul class="left hide-on-med-and-down" style="margin-left:5%;">
            <li><h1 class="fa fa-envelope">careers@pboglobal.com.au</h></li>              
        </ul>
